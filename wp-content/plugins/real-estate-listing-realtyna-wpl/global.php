...
class wpl_global
{
    ...
    /**
     * Add en email to Realtyna mailing list
     * @author Howard <howard@realtyna.com>
	 * @static
     * @param string $email
     * @return array
    ...
    public static function add_to_realtyna_mailing_list($email)
	{
        ...
        elseif($status == '1') $message = __('Your email has been added to our mailing list.', 'wpl');
        elseif($status == '2') $message = __('Your email has already been added.', 'wpl');
