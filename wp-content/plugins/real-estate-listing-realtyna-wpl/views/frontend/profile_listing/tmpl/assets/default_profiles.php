    ...
    <div class="wpl-column">
      <div itemscope class="wpl_profile_container <?php echo (isset($this->property_css_class) ? $this->property_css_class : ''); ?>" id="wpl_profile_container<?php echo $profile['data']['id']; ?>">
          ...
          <ul>
              ...
              <li itemprop="telephone" class="phone" data-toggle="tooltip" title="<?php echo $profile['materials']['tel']['value']; ?>"><?php echo $profile['materials']['tel']['value']; ?>
  				<a href="tel:<?php echo $profile['materials']['tel']['value']; ?>" class="phone-link"><?php echo $profile['materials']['tel']['value']; ?></a>
  			</li>
              <?php endif; ?>

              <?php if(isset($profile['materials']['mobile']['value'])): ?>
              <li itemprop="telephone" class="mobile" data-toggle="tooltip" title="<?php echo $profile['materials']['mobile']['value']; ?>"><?php echo $profile['materials']['mobile']['value']; ?>
  				<a href="tel:<?php echo $profile['materials']['mobile']['value']; ?>" class="mobile-link"><?php echo $profile['materials']['mobile']['value']; ?></a>
  			</li>
              <?php endif; ?>
