		...
		foreach($wpl_properties as $key=>$gallery)
		{
            ...
            <li>
                ...
                <div class="right_section">
                   <div class="title" itemprop="name"><a itemprop="url" class="more_info_title" href="'.$gallery["property_link"].'">'.$image_title.'</a></div>
                    <div class="location" itemprop="address">'.($location_visibility === true ? $gallery["location_text"] : $location_visibility).'</div>
